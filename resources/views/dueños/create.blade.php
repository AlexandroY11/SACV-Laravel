...
<form action="{{ route('dueños.store')}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nombre" aria-describedby="nombreHelp" name="nombre" placeholder="Nombre del dueño">
    </div>
    <div class="mb-3">
        <label for="apellido" class="form-label">Ingrese Apellido </label>
        <input type="text" class="form-control" id="apellido" aria-describedby="apellidoHelp" name="apellido" placeholder="Apellido del dueño">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="email" aria-describedby="razaHelp" name="email" placeholder="Email del dueño">
    </div>
    <div class="mb-3">
